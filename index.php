                                    ...
                                    <div class="row">
                                        <div class="col-12 align-self-center">
                                            <div class="text-start">
                                                <a href="https://www.instagram.com/zcode25/" target="_blank" class="btn btn-light btn-sm me-1">
                                                ...
                                                <a href="https://github.com/zcode25/daily-quran" target="_blank" class="btn btn-light btn-sm me-1">
        ...
        <div class="container">
            <div class="row">
                <?php foreach ($surah as $surah) : ?>
                    <div class="col-md-6 col-xl-4" style="cursor: pointer;" onclick="document.location.href = 'ayat.php?surah_id=<?= $surah['no_surah']; ?>';">
                        <div class="card mb-3">
                            <div class="row g-0">
                                <div class="col-2 rounded d-flex align-items-center justify-content-center" style="background-color: aliceblue;">
                                    <p class="card-text fw-bold"><?= $surah["no_surah"]; ?></p>
                                </div>
                                <div class="col-5 align-self-center">
                                    <h6 class="card-title fw-bold ms-3 mb-1"><?= $surah["nama_surah"]; ?></h6>
                                    <p class="card-text text-secondary info ms-3"><?= $surah["arti_surah"]; ?></p>
                                </div>
                                <div class="col-5">
                                    <div class="card-body text-end">
                                        <p class="card-text text-secondary info mb-1"><?= $surah["turun_surah"]; ?></p>
                                        <p class="card-text text-secondary info"><?= $surah["ayat_surah"]; ?> Ayat</p>
                                    </div>
                                </div>
                            </div>
                        </div>
